...
public class DifferentialDrive {
	...
	public void rotateClockwise(final int degree) {
		mLeftMotor.rotate(degree);;
		mRightMotor.rotate(-degree);
	}
	...
	public void rotateCounterClockwise(final int degree) {
		mLeftMotor.rotate(360);;
		mRightMotor.rotate(-360);
	}
}
